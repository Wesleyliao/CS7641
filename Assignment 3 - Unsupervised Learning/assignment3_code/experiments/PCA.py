...
class PCAExperiment(experiments.BaseExperiment):
    ...
    def __init__(self, details, verbose=False):
        ...
        self._dims = [2, 3, 4, 5, 6, 7, 8, 9, 10, 15, 20, 25, 30, 40, 50, 60, 70, 80]
    ...
    def perform(self):
        ...
        tmp = pd.Series(data=pca.explained_variance_, index=range(1, min(pca.explained_variance_.shape[0], 1000) + 1))
        ...
        # ds.shape[1]
        # if (max(self._details.ds.training_x.shape) <= 1000 or
