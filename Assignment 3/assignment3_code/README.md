...
## Scree Plots and Initial Experiments

To get the "knee" values and dimensions for clustering analysis, run:
...
To combine results from Neural Networks run:

```
python consolidate_nn_data_clean.py
```
