...
if __name__ == '__main__':
    ...
    ds1_data = loader.FashionData(verbose=verbose, seed=seed)
    ds1_name = 'fashion'
    ds1_readable_name = 'Fashion MNIST'
    ds1_data.load_and_process()

    ds2_data = loader.NBAData(verbose=verbose, seed=seed)
    ds2_name = 'NBA'
    ds2_readable_name = 'NBA Shots'
